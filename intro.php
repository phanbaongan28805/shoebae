            ...
            <div class="blog row-revere">
                ...
                <div class="blog-info">
                    ...
                    <div class="blog-preview-2">
                        ...
                        được
                        đồng
                        hành cùng quý khách hàng để mang tới sự trải nghiệm thoải mái và hài lòng.
                    </div>
    	...
    	<div class="card">
    		...
    		<div class="card-body">
    			<div class="row">
    				...
    				<div class="col-sm-4 text-center">
    					<h3 class="mt-4 mb-3">Bạn có hài lòng về chúng tôi</h3>
    		...
    		if (isset($insertMail)) {
    		 ...
    		 ?>
                        <form action="index.php" method="post" enctype="multipart/form-data">
                            <input type="email" name="email" placeholder="Nhập Địa Chỉ Email" style=" width:300px;">
