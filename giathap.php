...
<body>
 ...
 ?>
    ...
    <?php
 $pdall = $pd-> getproduct_giathap();
    $product_count = mysqli_num_rows( $pdall);
    $product_button = ceil($product_count/2);
    $i =1;
    ...
    <div class="box">
        <ul class="pagination">
            <li><a href="giathap.php?trang=<?php echo ''.$i.''?>" class="active"><?php echo ''.$i.''?></a>
            </li>
        </ul>
    </div> <?php
        }?>
