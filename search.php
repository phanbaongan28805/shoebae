...
<body>
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="row" id="">
                <?php 
                                    $con = mysqli_connect("localhost","root","","web_mvc");
                                    if(isset($_GET['search']))
                                    {
                                        $filtervalues = $_GET['search'];
                                        $query = "SELECT * FROM tbl_product WHERE productName  LIKE '%$filtervalues%' or color  LIKE '%$filtervalues%' ";
                    ...
                    <div class="product-card">
                        <div class="product-card-img">
                            <a href="detail.php?proid=<?= $items['productId']; ?>">
                                <img src="admin/uploads/<?= $items['image']; ?>" alt="" /></a>
